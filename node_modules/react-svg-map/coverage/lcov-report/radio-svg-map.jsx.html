...
<html lang="en">
<head>
    <title>Code coverage report for radio-svg-map.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> radio-svg-map.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
		...
		<span class="missing-if-branch" title="else path not taken" >E</span>if (this.props.onChange) {
...
&nbsp;
			...
			this.selectLocation(focusedLocation.nextSibling || <span class="branch-1 cbranch-no" title="branch not covered" >this.locations[0])</span>;
&nbsp;
			// Arrow up or left
		} else <span class="missing-if-branch" title="else path not taken" >E</span>if (event.keyCode === 37 || <span class="branch-1 cbranch-no" title="branch not covered" >event.keyCode === 38)</span> {
			event.preventDefault();
&nbsp;
			// Select previous or last location
			this.selectLocation(focusedLocation.previousSibling || <span class="branch-1 cbranch-no" title="branch not covered" >this.locations[this.locations.length - 1])</span>;
		}
	}
&nbsp;
	render() {
...
&nbsp;
export default RadioSVGMap;</pre></td></tr>
</table></pre>
<div class='push'></div><!-- for sticky footer -->
</div><!-- /wrapper -->
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Sat Apr 20 2019 15:03:03 GMT+0800 (CST)
</div>
</div>
